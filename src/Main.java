...
public class Main extends Configured implements Tool {
	public static String path_download_cluster_centers = "C:\\KhaiPhaDuLieu\\cluster_centers.txt";
	public static String path_download_data_output = "C:\\KhaiPhaDuLieu\\data_output.csv";
